      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <ScrollReveal>
              <div>
                <h2 className="text-3xl font-bold text-primary mb-8">Why Join UYP?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <ScrollReveal>
              <div className="bg-white p-8 rounded-xl text-center border border-border hover:shadow-md transition-all">
                ...
                <p className="text-muted-foreground text-sm break-all">contact@uthanyouthparliament.org</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={0.1}>
              <div className="bg-white p-8 rounded-xl text-center border border-border hover:shadow-md transition-all">
                ...
                <p className="text-muted-foreground text-sm">@uthanyouthparliament</p>
              </div>
            </ScrollReveal>
