...
const teamMembers = [
  {
    ...
    image: "/placeholder.svg?key=z8xnh",
    isMember: false,
    facebookUrl: "",
  },
  {
    name: "Mr. P. L. Punia",
    role: "Chief Patron (MP, Rajya Sabha)",
    image: "/placeholder.svg?key=rga83",
    isMember: false,
    facebookUrl: "",
  },
  {
    ...
    image: "/placeholder.svg?key=k0b28",
    isMember: true,
    facebookUrl: "",
  },
  { name: "Ms. Jyoti Gupta", role: "President", image: "/placeholder.svg?key=j5exk", isMember: true, facebookUrl: "" },
]

const timeline = [
  { year: 2017, event: "Uthan Youth Parliament Founded", milestone: "Origins" },
  { year: 2018, event: "First Edition with 500+ Participants", milestone: "Launch" },
  { year: 2019, event: "Expanded to 15 States Across India", milestone: "Growth" },
  { year: 2020, event: "Virtual Platform During Pandemic", milestone: "Innovation" },
  { year: 2021, event: "Season 6 - 5000+ Participants", milestone: "Scale" },
  { year: 2026, event: "Season 7 - Growing Across the Nation", milestone: "Present" },
]
    ...
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-20 pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-4 text-balance">About Uthan Youth Parliament</h1>
