...
export default function UpcomingEvents() {
  ...
  const timeline = [
    { date: "Jan 1, 2026", event: "Registration Opens", description: "Online registration begins" },
    { date: "Jan 10, 2026", event: "Early Bird Deadline", description: "Last day for early bird discount" },
    { date: "Jan 15, 2026", event: "Schedule Release", description: "Detailed event schedule announced" },
    { date: "Jan 17, 2026", event: "Season 7 Launch", description: "Main event day" },
  ]
    ...
    <main className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground py-20 pt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <div>
              <h1 className="text-5xl md:text-6xl font-bold mb-4 text-balance">Season 7: The Next Chapter</h1>
              <p className="text-xl opacity-90">Uthan Youth Parliament 2026 - Bigger, Better, Brighter</p>
            </div>
          </ScrollReveal>
        </div>
      </section>
